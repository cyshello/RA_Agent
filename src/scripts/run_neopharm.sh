...
# 파라미터 설정
COMPANY_NAME="Neopharm"
DOCUMENTS="IR2:data/IR2.pdf"  # 여러 문서: "doc1:path1 doc2:path2"
...
REPORT_MODEL_NAME="gemini-2.5-pro" #"gpt-4o"                       # 사용 가능: gpt-4o, gpt-4o-mini, o1-preview, o1-mini
