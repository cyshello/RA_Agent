...
echo ""
echo "  # DB 통계 확인"
echo "  python $PROJECT_DIR/scripts/check_db.py"
echo ""
echo "  # 검색 테스트"
echo "  python $PROJECT_DIR/scripts/search_test.py \"디지털 전환\" --all"
echo ""
echo "  # MySQL 직접 조회"
echo "  mysql -u $DB_USER $DB_NAME -e \"SELECT 과제명 FROM national_projects LIMIT 5;\""
echo ""
